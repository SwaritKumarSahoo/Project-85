...
function add() {
	...
	greencar_imageTag.upload = uploadBackground;
...
function uploadgreencar() {
    ...
    ctx.drawImage(greencar_imageTag, greencar_image_x, greencar_image_y, greencar_image_width, greencar_image_height);
